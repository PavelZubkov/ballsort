...
declare namespace $ {
	...
	type $mol_view__style__D943SG6S = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__JEHUKAF4 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__IYNUCI2U = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $hype_ballsort_ball_view__ball__XYE6QJRQ = $mol_type_enforce<
		ReturnType< $hype_ballsort_tube_view['ball'] >
		,
		ReturnType< $hype_ballsort_ball_view['ball'] >
	>
	type $mol_list__style__RE72AJCO = $mol_type_enforce<
		({ 
			'min-height': string,
		}) 
		,
	...
	>
	type $mol_list__attr__OOU1YGG2 = $mol_type_enforce<
		({ 
	...
	>
	type $mol_list__rows__2XTQ6LYH = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__sub__E7O4HHY9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub__IESS4AYP = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__dom_name__PK6PXDP9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__J5BHJOB2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $hype_ballsort_button__title__YMS5EYRG = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_button['title'] >
	>
	type $hype_ballsort_button__click__QC7C64Y1 = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['start'] >
		,
		ReturnType< $hype_ballsort_button['click'] >
	>
	type $hype_ballsort_link__title__GBT92EPD = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['title'] >
	>
	type $hype_ballsort_link__href__8Q2Q2Y51 = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['href'] >
	>
	type $hype_ballsort_link__target__FQB4TIK1 = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['target'] >
	>
	type $hype_ballsort_link__title__AI9QCLHS = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['title'] >
	>
	type $hype_ballsort_link__href__CIX2M8S5 = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['href'] >
	>
	type $hype_ballsort_link__target__PFMCBI20 = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['target'] >
	>
	type $hype_ballsort_link__title__RU2TSQCJ = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['title'] >
	>
	type $hype_ballsort_link__href__05VVHNJH = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['href'] >
	>
	type $hype_ballsort_link__target__U3JHGH6V = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['target'] >
	>
	type $hype_ballsort_link__title__5WKCPMOC = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['title'] >
	>
	type $hype_ballsort_link__href__E2W5V1GH = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['href'] >
	>
	type $hype_ballsort_link__target__NIWTJDEQ = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['target'] >
	>
	type $hype_ballsort_link__title__GLSOYIGX = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['title'] >
	>
	type $hype_ballsort_link__href__XLE594X5 = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['href'] >
	>
	type $hype_ballsort_link__target__PU89DO6Q = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_link['target'] >
	>
	type $mol_view__sub__J5BND89K = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $hype_ballsort_button__title__RGP3SYQ9 = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_button['title'] >
	>
	type $hype_ballsort_button__click__DTWQ8N8C = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['home'] >
		,
		ReturnType< $hype_ballsort_button['click'] >
	>
	type $hype_ballsort_button__title__IGV8VSK9 = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_button['title'] >
	>
	type $hype_ballsort_button__click__A8OOUN8U = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['start'] >
		,
		ReturnType< $hype_ballsort_button['click'] >
	>
	type $mol_view__sub__I49IHPOP = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub__5PLQ411D = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $hype_ballsort_tube_view__tube__TUG41PW8 = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['tube'] >
		,
		ReturnType< $hype_ballsort_tube_view['tube'] >
	>
	type $hype_ballsort_tube_view__click__YKYXTDLH = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['tube_click'] >
		,
		ReturnType< $hype_ballsort_tube_view['click'] >
	>
	type $hype_ballsort_tube_view__active__179F9OZY = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['tube_active'] >
		,
		ReturnType< $hype_ballsort_tube_view['active'] >
	>
	type $mol_view__sub__U06ORPHL = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['tubes'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__dom_name__U2P4TEQB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__UHU53X6L = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__dom_name__N0UE2XS0 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__6KJYUG2W = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $hype_ballsort_button__title__C1IZ9NOP = $mol_type_enforce<
		string
		,
		ReturnType< $hype_ballsort_button['title'] >
	>
	type $hype_ballsort_button__click__6YSN94IM = $mol_type_enforce<
		ReturnType< $hype_ballsort_app['home'] >
		,
		ReturnType< $hype_ballsort_button['click'] >
	>
	type $mol_list__rows__GPNDNV24 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows__OG942ODY = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows__71I34TGS = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows__TJWQ08Q8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
