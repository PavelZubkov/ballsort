...
(function ($) {
    ...
    (function ($$) {
        class $hype_ballsort_ball_view extends $.$hype_ballsort_ball_view {
            ...
            color_light() {
                return this.colors()[this.color_index() + 1];
            }
        }
...
(function ($) {
    ...
    (function ($$) {
        class $hype_ballsort_tube_view extends $.$hype_ballsort_tube_view {
            roof() {
                return this.active() ? this.Ball(this.tube().balls().length - 1) : null;
            }
            balls() {
...
;
	...
	($mol_mem(($.$hype_ballsort_app.prototype), "Start"));
	($mol_mem(($.$hype_ballsort_app.prototype), "Effector"));
	($mol_mem(($.$hype_ballsort_app.prototype), "Reatom"));
	($mol_mem(($.$hype_ballsort_app.prototype), "Vue"));
	($mol_mem(($.$hype_ballsort_app.prototype), "Mol"));
